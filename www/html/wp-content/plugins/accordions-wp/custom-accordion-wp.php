...
function tp_accordions_frees_options_framework() {
	...
	<div class="wrap about-wrap">
		<h1>Welcome to Accordion - V1.8</h1>

		<div class="about-text">Thank you for using our Accordion-Wp plugin free version.</div>
		
		<hr>

		<h3>We create a <a target="_blank" href="http://themepoints.com/product/wp-accordions-pro/">premium version</a> of this plugin with some amazing cool features?</h3>
		<br>
		...
		<h2><a href="http://themepoints.com/product/wp-accordions-pro/" class="button button-primary button-hero" target="_blank">Buy Premium Version Only $8</a>
		</h2>
		<br>
		<br>
		<br>
